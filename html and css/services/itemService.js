(function () {
  ...
  const items = [
    {
      ...
      protection: { deposit: 45500, details: "Security deposit held until return. Basic vehicle protection available at checkout." },
    },
    {
      ...
      protection: { deposit: 26000, details: "Security deposit held until return. Damage protection available at checkout." },
    },
    {
      ...
      protection: { deposit: 10400, details: "Deposit covers missing parts and accidental tool damage." },
    },
    {
      ...
      protection: { deposit: 39000, details: "Deposit required. Device condition is verified at pickup and return." },
    },
    {
      ...
      protection: { deposit: 19500, details: "Deposit held against lens, remote, or cable damage." },
    },
    {
      ...
      protection: { deposit: 13000, details: "Deposit covers accessories and cleaning equipment condition." },
    },
    {
      ...
      protection: { deposit: 32500, details: "Deposit covers stains, upholstery damage, and transport issues." },
    },
    {
      ...
      protection: { deposit: 15600, details: "Deposit covers frame, tire, and gear damage." },
    },
  ];

  const extraTitles = [
    ["gopro-hero-12", "GoPro Hero 12", "cameras", 3200],
    ["sony-mirrorless-kit", "Sony Mirrorless Kit", "cameras", 7800],
    ["50mm-prime-lens", "50mm Prime Lens", "cameras", 2000],
    ["portable-lighting-kit", "Portable Lighting Kit", "cameras", 2300],
    ["360-action-camera", "360 Action Camera", "cameras", 3900],
    ["55-smart-tv-4k", '55" Smart TV 4K', "electronics", 5200],
    ["portable-bluetooth-speaker", "Portable Bluetooth Speaker", "electronics", 1000],
    ["noise-cancelling-headphones", "Noise-Cancelling Headphones", "electronics", 1500],
    ["standing-desk-adjustable", "Standing Desk Adjustable", "furniture", 1500],
    ["solid-wood-dining-table", "Solid Wood Dining Table", "furniture", 5200],
    ["leather-armchair", "Leather Armchair", "furniture", 2300],
    ["open-bookshelf", "Open Bookshelf", "furniture", 1300],
    ["golf-set", "Golf set", "sports", 2600],
    ["single-kayak", "Single Kayak", "sports", 2800],
    ["stand-up-paddleboard", "Stand-Up Paddleboard", "sports", 2300],
    ["climbing-gear-set", "Climbing Gear Set", "sports", 3200],
    ["electric-lawn-mower", "Electric Lawn Mower", "tools", 3900],
    ["circular-saw-pro", "Circular Saw Pro", "tools", 2600],
    ["orbital-sander", "Orbital Sander", "tools", 1300],
    ["honda-civic-2022", "Honda Civic 2022", "vehicles", 6000],
    ["ford-transit-van", "Ford Transit Van", "vehicles", 10400],
    ["mini-cooper-2020", "Mini Cooper 2020", "vehicles", 6500],
    ["7-seater-suv", "7-Seater SUV", "vehicles", 11700],
  ];
  ...
  extraTitles.forEach(([id, title, category, pricePerDay]) => {
    ...
    items.push({
      ...
      protection: { deposit: Math.max(5000, pricePerDay * 4), details: "Refundable deposit held until the item is safely returned." },
    });
  });
